...
- **Requisito 1:** Tal y como se menciona anteriormente, en el sprint pasado se nos quedó pendiente el requisito de realizar algún puzzle a lo largo del juego, es por ello que en este lo hemos incorporado de tal forma que para acceder a una determinada situación sea necesario coger un cierto objeto.
- **Requisito 2:** Este es el único requisito innegociable que nos quedaba aun por realizar, es por ello que ya lo hemos incorporada dado que nos venía perfecto para complementarlo con el requisito anterior.
...
-**Conclusiones Sprint Review:** Hemos continuado con la forma de organización de los anteriores Sprint, es decir, organizando las HU para ese sprint en otro tablero distinto en Trello y ahí mismo gestionar todas las tareas necesarias para completar esas HU. En este Sprint partíamos de la base donde lo dejamos el sprint pasado, es decir, nuestro compañero Alberto sigue sin dar señales de ningún tipo, por ello empezamos el resto de integrantes a realizar este Sprint. Dado que teníamos numerosas entregas y demás no nos veíamos muy capacitados para realizar una gran cantidad de requisitos, o al menos realizar todo los que nos hubiera gustado en condiciones normales, por ello decidimos irnos a lo que teníamos que realizar obligatoriamente, los 2 requisitos que se han explicado con anterioridad.

-**Conclusiones Sprint Retrospective:** En este Sprint hemos tenido algo menos dificultades que en el pasado Sprint pues a pesar de la situación que vivimos actualmente de confinamiento, y el no poder realizar las diferentes reuniones y organizarnos todo lo bien que nos gustaría, estamos más adaptados a esta situación que en el sprint pasado, además en este no ha habido ningún tipo de sorpresas a nivel de equipo por lo que el trabajo ha sido lineal. El único factor más limitante era la falta de tiempo y el número de entrega que los diferentes integrantes del equipo activo teníamos. Sin embargo, tras echarle dedicarle un tiempo a los primeros requisitos que fueron planteados, se observó que podríamos hacer algo más para mejorar nuestro juego, y pasamos a ampliar el Sprint BackLog y mejorar 2 requisitos que ya teníamos completados, pero que considerábamos que eran sustancialmente mejorables de cara al usuario. Una vez todos estos requisitos implementados correctamente, se observamos que el resultado de nuestro juego es aceptable para las dificultades que hemos tenido a lo largo de este tiempo, bien es cierto que nos hubiera gustado implementar un mayor número de requisitos, pero como se ha expuesto anteriormente, no ha sido posible por diferentes inconvenientes. En cuanto a la forma de trabajo del equipo, obviando la ausencia de Alberto, el resto nos conseguimos entender bien, con una buena comunicación, y una disponibilidad acorde a las exigencias de la práctica.
